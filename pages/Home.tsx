...
const HomePage = ({ onNavigate }: { onNavigate: (path: string) => void }) => {
  ...
  const homeSchema = {
    ...
    "sameAs": [
      "https://twitter.com/financewithkasif",
      "https://linkedin.com/in/financewithkasif"
    ]
  };
  ...
  return (
    <>
      <SEO 
        title="Finance with Kasif | Top Stock Market & Wealth Strategies India"
        description="Master your money with Finance with Kasif (FK). Expert guides on SIPs, IPOs, Nifty 50, and long-term wealth creation for Indian investors."
        keywords={['Stock Market India', 'SIP Calculator', 'Best Mutual Funds 2025', 'Finance with Kasif', 'FK', 'Nifty 50 Analysis', 'Intraday Trading Tips']}
        schema={homeSchema}
      />
